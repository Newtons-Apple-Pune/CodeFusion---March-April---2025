                ...
                <input
                  ...
                  className=" block w-full px-3 py-2 pl-10 bg-white border border-gray-600 
									rounded-md shadow-sm
									 placeholder-white focus:outline-none focus:ring-white 
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className=" block w-full px-3 py-2 pl-10 bg-white border border-gray-600 
									rounded-md shadow-sm placeholder-white focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm"
                  placeholder="••••••••"
                />
              </div>
            </div>
